...
test('source maps trace back to @import location', async ({ expect }) => {
  ...
  expect(annotations).toEqual([
    ...
    'preflight.css: 119:6-63 <- 294:4-80',
    'preflight.css: 122:2-11 <- 302:0-9',
    'preflight.css: 123:4-20 <- 303:2-18',
    'preflight.css: 125:2-30 <- 310:0-28',
    'preflight.css: 126:4-28 <- 311:2-26',
    'preflight.css: 128:2-32 <- 319:0-30',
    'preflight.css: 129:4-19 <- 320:2-17',
    'preflight.css: 130:4-23 <- 321:2-21',
    'preflight.css: 132:2-26 <- 328:0-24',
    'preflight.css: 133:4-24 <- 329:2-22',
    'preflight.css: 135:2-41 <- 336:0-39',
    'preflight.css: 136:4-14 <- 337:2-12',
    'preflight.css: 138:2-329 <- 340:0-348:39',
    'preflight.css: 139:4-20 <- 349:2-18',
    'preflight.css: 141:2-38 <- 356:0-36',
    'preflight.css: 142:4-18 <- 357:2-16',
    'preflight.css: 144:2-19 <- 364:0-17',
    'preflight.css: 145:4-20 <- 365:2-18',
    'preflight.css: 147:2-96 <- 372:0-374:23',
    'preflight.css: 148:4-22 <- 375:2-20',
    'preflight.css: 150:2-59 <- 382:0-383:28',
    'preflight.css: 151:4-16 <- 384:2-14',
    'preflight.css: 153:2-47 <- 391:0-45',
    'preflight.css: 154:4-28 <- 392:2-26',
